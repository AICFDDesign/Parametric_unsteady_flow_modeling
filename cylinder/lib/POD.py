...
class POD:
    def __init__(self, datafile, n_train, n_test, re, path, n_modes=100, delta_t=1, case=10) -> None:
        """
        A runner for POD
        ...
        self.re = re
        self.case = case    
        self.casename = f'POD_Re{self.re}_dt{self.delta_t}_ntest{self.n_test}_nmodes{self.n_modes}_case{case+1}.mat'
