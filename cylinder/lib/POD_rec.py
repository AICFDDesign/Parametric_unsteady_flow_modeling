...
class POD:
    ...
    def load_data(self, path, case=10):
        ...
        w = scipy.io.loadmat(self.datafile)['Rec_from_VAE_T_test']
...
if __name__ == "__main__":
    # data
    datafile = "../figs/easy/One_TestCase_reconstruc_easyAttn_32in_32dmodel_1next_3dim_timeemb_4h_4nb_128ff_reluact_Noneoutact_200Epoch_135000N_TrueES_50P.mat"

    re = 200
    delta_t = 1
    n_modes = 10
    n_test = 20 // delta_t
    POD_train = POD(datafile, 80, n_test, re, n_modes, delta_t)
    for i in range(4,5):
        print(f'Case {i+1}/15')
