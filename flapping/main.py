...
"""
Main program for flapping airfoil case
"""
...
parser.add_argument('-nn',default="lstm", type=str,   help="Choose the model for time-series prediction: easy, self OR lstm")
parser.add_argument('-re',default=100,     type=int,   help="200 OR 100, Choose corresponding Reynolds number for the case")
